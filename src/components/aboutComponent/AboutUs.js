                        ...
                        <div className="col-lg-6">
                            <div className="about-content">
                                <div className="section-heading style-left">
                                    <span className="section-heading__subtitle bg-gray-100"><span className="text-gradient fw-semibold">About Us</span></span>
                                ...
                                <div className="about-button">
                                    <a href="#" className="btn btn-outline-main bg-white">Learn More <span className="icon-right"><i className="fas fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
