...
import './Checkout.css'
import paypal from '../../assets/images/thumbs/paypal.png'
import visa from '../../assets/images/thumbs/visa.png'
                            ...
                            <div className="col-lg-4">
                                ...
                                <div className="card common-card">
                                    <div className="card-body">
                                        ...
                                        <button type="submit" className="btn btn-main w-100 mt-4">Pay Now</button>
                                    </div>
                                </div>
                            </div>
                        </div>
